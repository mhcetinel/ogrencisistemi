...
namespace ogrencisistemi.Controllers
{
    public class OgrenciController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Ad,Soyad,Tc,Adres,Telefon,BasariDurumu,Aldigiegitim")] Ogrenci ogrenci)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Ad,Soyad,Tc,Adres,Telefon,BasariDurumu,Aldigiegitim")] Ogrenci ogrenci)
        {
            if (ModelState.IsValid)
            {
